...
knowledge-os 仓库 [`docs/image-prompt-engineering/`](https://github.com/menglingqing/knowledge-os/tree/main/docs/image-prompt-engineering)（当前对齐 v1.1）

同步方向单向：knowledge-os → core.md。知识库更新后由人类建筑师决定是否提炼进 core.md 并升版本号。

## 版本

agent v1.1 · 知识 v1.1 · 2026-08-18
